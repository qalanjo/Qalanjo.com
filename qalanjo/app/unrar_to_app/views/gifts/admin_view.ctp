...
<h2><?php  __('Gift');?></h2>
	<dl><?php $i = 0; $class = ' class="altrow"';?>
		...
		<dd<?php if ($i++ % 2 == 0) echo $class;?>>
			<?php echo $gift['Gift']['picture_path']; ?>
			&nbsp;
		</dd>
	...
	<?php
		...
		<tr<?php echo $class;?>>
			...
			<td class="actions">
				...
				<?php echo $this->Html->link(__('Edit', true), array('controller' => 'gift_avail_transaction_items', 'action' => 'edit', $giftAvailTransactionItem['id'])); ?>
				<?php echo $this->Html->link(__('Delete', true), array('controller' => 'gift_avail_transaction_items', 'action' => 'delete', $giftAvailTransactionItem['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $giftAvailTransactionItem['id'])); ?>
			</td>
		</tr>
	<?php endforeach; ?>
	</table>
