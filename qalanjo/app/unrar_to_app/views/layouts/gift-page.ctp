...
<html xmlns="http://www.w3.org/1999/xhtml">
 	...
 	<!--created by Jan Evan Dominic La Rosa-->

<head>
<title>Qalanjo.com Gifts</title>
<meta http-equiv="Content-Type" content="application/xhtml+xml; charset=UTF-8" />
<link rel="stylesheet" type="text/css" media="screen, print, projection"  href="css/gifts.css"></link>
<?php echo $this->Javascript->link(array("jquery", "jquery.autocomplete.min.js"))?>
...
<div id="top">
 <div id="page">
     ...
     <div id="leftSideMenu">
             <?php 
			 	$image = $this->Html->image("gifts/logo.png", array("alt"=>"Qalanjo","height"=>"117","width"=>"123"));
				echo $this->Html->link($image,"#",array("escape"=>false,"title"=>"Qalanjo"));
			 ?>
             <?php
			 	$image = $this->Html->image("gifts/profilepic.png", array("alt"=>"Qalanjo","height"=>"90","class"=>"profilePicture"));
