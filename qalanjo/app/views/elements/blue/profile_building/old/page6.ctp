<div class="left" id="content_header">
	<h2>Lifestyle cont'</h2>
</div>
	<div class="left" id="content_main">
		<p class="instruction">Your Lifestyle:</p>
       	<p class="image_set_top right">
       		<?php 
				$path = "designs/blue/members/profile_completion/page6/";
				echo $this->Html->image($path."woman1.jpg", array("alt"=>"Woman Smoking", "class"=>"right"));
			?>		
       	</p>
