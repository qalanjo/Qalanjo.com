<?php 
	$path = "designs/blue/attributes/questionnaire/page1/";
?>
...
<div class="left" id="content_main">
	...
	<?php 
		echo $this->Html->image($path."woman1.jpg", array("alt"=>"Woman Thinking", "class"=>"right"));
	?>
	<?php 
	...
	<p class="image_set_bottom">
		<?php 
			echo $this->Html->image($path."man1.jpg", array("alt"=>"Man Happy", "class"=>"left"));
		?>
