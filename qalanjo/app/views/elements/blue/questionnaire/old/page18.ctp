<?php 
	$path = "designs/blue/attributes/questionnaire/page18/";
?>
...
<div class="left" id="content_main">
	...
	<p class="image_set_top">
		<?php echo $this->Html->image($path."image018a.jpg", array("class"=>"right"))?>
	</p>
	<?php 
	...
	<p class="image_set_bottom">
		<?php echo $this->Html->image($path."image018b.jpg", array("class"=>"left"))?>
