<?php echo $this->Javascript->link("tiny_mce/jquery.tinymce.js")?>
<script type="text/javascript">
//<![CDATA[
	/**	
 	* Use to textarea to TinyMCE 
	 */
	function transform_editor(){
		$('textarea.tinymce').tinymce({
			...
			theme_advanced_buttons3 : "sub,sup,|,charmap,emotions,iespell,advhr,|,print,|,ltr,rtl,|,fullscreen",
